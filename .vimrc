...
autocmd BufNewFile *.cpp,*.[ch],*.sh,*.java,*.py,*.js exec ":call SetTitle()" 
...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "\# Author: Bin Xu") 

        call append(line(".")+2, "\# mail: x_shares@outlook.com") 
	...
	elseif &filetype == 'python'
		...
		call append(line("."),"# -*- codeing:utf-8 -*-")
        call append(line(".")+1, "") 
