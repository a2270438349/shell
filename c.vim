...
syn keyword	process	goto break return continue asm
syn keyword	cLabel		case default
syn keyword	cConditional	if else switch
syn keyword	cRepeat		while for do
hi process ctermfg=70
hi cLabel ctermfg=70
hi cConditional ctermfg=130
hi cRepeat ctermfg=130
...
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		size_t ssize_t off_t wchar_t ptrdiff_t sig_atomic_t fpos_t pid_t
  syn keyword   cType		clock_t time_t va_list jmp_buf FILE DIR div_t ldiv_t
  syn keyword   cType		mbstate_t wctrans_t wint_t wctype_t socklen_t pthread_t
endif
if !exists("c_no_c99") " ISO C99
  ...
  syn keyword	cType		s1 s2 s4 s8 u1 u2 u4 u8 f4 f8
endif
if exists("c_gnu")
...
hi cString ctermfg=135
hi def link cCppString		cString
hi def link cCommentL		cComment
hi def link cCommentStart	cComment
"hi def link cLabel		Label
"hi cLabel ctermfg=155
hi def link cUserLabel		Label
"hi def link cConditional	Conditional
"hi def link cRepeat		Repeat
"hi cRepeat ctermfg=40
...
hi cOperator ctermfg=200
"hi def link cStructure		Structure
hi cStructure ctermfg=135
hi def link cStorageClass	StorageClass
""hi def link cInclude		Include
hi cInclude ctermfg=32
""hi def link cPreProc		PreProc
hi cPreProc ctermfg=126
""hi def link cDefine		Macrof
hi cDefine ctermfg=3
""hi def link cIncluded		cString
hi cIncluded ctermfg=165
...
hi cType ctermfg=166
"hi def link cConstant		Constant
hi cConstant ctermfg=170
hi def link cCommentString	cString
hi def link cComment2String	cString
hi def link cCommentSkip	cComment
hi def link cString		String
""hi def link cComment		Comment
hi cComment ctermfg=243
...
syn match	typedefcolor	display contained "typedef\s+struct\s+(?\w+)\s"
